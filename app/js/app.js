;(function () {
    angular.module('loanPound', ['ngRoute', 'restangular'])
        .config(function (CONFIG, oauthProvider, RestangularProvider, $httpProvider) {
            ...
            if (oauthProvider.getToken()) {
                $httpProvider.defaults.headers.common.Authorization = 'Bearer ' + oauthProvider.getToken();
            }

            RestangularProvider.setBaseUrl(CONFIG.API_BASE_URL);
        })
        .run( function (oauth, $rootScope, Restangular) {
